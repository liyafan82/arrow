...
public class TpchQ1Test extends SqlPerformancefTestBase {
  ...
  public TpchQ1Test(VectorFactory.VectorType vectorType) {
  ...
  private long projectAndFilter1() {
    ...
    // create input data
    ValueVector[] inputVectors = createVectors(inputFields, true, vectorType);
    ...
    // create output data
    ValueVector[] outputVectors = createVectors(outputFields, false, vectorType);
